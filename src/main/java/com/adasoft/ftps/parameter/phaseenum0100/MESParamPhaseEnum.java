...
public class MESParamPhaseEnum extends BulkSaveableMESATObject implements IMESProcessParameterData {
    ...
    public String getATDefinitionName() {
        return "C_ParamPhaseEnum0100";
    }

    public MESParamPhaseEnum(long key) {
        super(key);
    }

    public MESParamPhaseEnum(MESParamPhaseEnum source) {
        super(source);
    }

    public MESParamPhaseEnum(ATRow baseATRow) {
        super(baseATRow);
    }

    public MESParamPhaseEnum() {
    }
